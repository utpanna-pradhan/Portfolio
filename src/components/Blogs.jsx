      ...
      >
        <div className="container-fluid">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
          >
            <h2 className="bluecolor  latest_heading">Latest Blogs</h2>
          </motion.div>
          ...
          >
            <div className="latest_blog">
              ...
              <div className="latest_blog_content w-50">
                <div className="blog_side_title bluecolor">
                ...
                <div className="blog_side_desc pb-4">
                  <p>
                    I write practical and simplified blogs on core frontend
                    topics including HTML, CSS, JavaScript, React, Git, and
                    more. Whether it's concepts, how-to guides, or handy tips —
                    everything is shared in a beginner-friendly way.
                  </p>
                </div>
                ...
                <div className="blog_side_desc pb-4">
                  <p>
                    ...
                    you'll find practical explanations and use cases for core
            ...
            {filteredBlogs.map((blog) => (
              ...
              >
                ...
                <div className="blog_card_content">
                  <h4 className="bluecolor">{blog.title}</h4>
                  <p>{blog.description.slice(0, 150)}...</p>
